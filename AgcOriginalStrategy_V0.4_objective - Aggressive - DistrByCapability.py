#  本程序的上调空间基于装机容量分配，而不是基于实际发电功率分配
                ...
                # Case 1.2.1: |P_real - P_ref| <= epsilon
                    if catch_mode == 'Inbound':
                        ...
                        dic_tmp_p_ref[key] = self.AgcObjDict[key].d_real_out + \
                            self.AgcObjDict[key].d_capacity * (self.P_LIMIT - self.AgcRealOutSumUp()) / self.TotalCapacity
...
if __name__ == '__main__':
    for tmp_limit in [1300]:
        ...
        OutDir = 'D:/Work/新能源工作/[Routine] 未分组工作/20191126-吴所论文送出送出极限对比/03-Aggressive-CapabilityBased/'
